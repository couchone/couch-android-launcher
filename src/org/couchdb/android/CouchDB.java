...
public class CouchDB extends Activity {
    ...
    private void setFutonView() { 
    	...
    	webView.setHttpAuthUsernamePassword("127.0.0.1", "administrator", adminUser, adminPass);
    ...
    private void confirmDelete() { 
    	...
    	builder.setMessage("Are you sure you want to delete, this will delete all of your existing data?")
    	       .setCancelable(false)
    ...
    private ICouchClient mCallback = new ICouchClient.Stub() {
		...
		@Override
		public void databaseCreated(String ctrl, String name, String user, String pass, String tag) 
			throws RemoteException {}

		@Override
		public void adminCredentials(String user, String pass) throws RemoteException { 
			adminUser = user;
			adminPass = pass;
